    ...
    return (
        ...
        <div className="shadow card">
            <div className="card-body">
                ...
                <div>
                    <span className="font-weight-bold">Nome da empresa: </span>Digital S.A.
                </div>
                <br/>
                ...
                <hr />
                <div>
                    <span className="font-weight-bold">Forma de pagamento: </span> A combinar
                </div>
                <div>
                    <span className="font-weight-bold">Faixa de preço: </span> R$400,00 até R$900,00
                </div>
                <hr />
                <div>
                    <span className="font-weight-bold">Habilidades: </span> Pintura em aquarela.
                </div>
                <div>
                    <span className="font-weight-bold">Experiências: </span> intermadiário.
                </div>
                <hr />
                ...
                <form>
                    <div className="form-row">
                        <div class="form-group col">
                            ...
                            <input type="number" min="0.00" max="10000.00" step="0.10" class="form-control" id="recipient-name" required/>
                        </div>
                        <div class="form-group col">
                            <label for="recipient-name" class="col-form-label">Data de entrega:*</label>
                            <input type="date" class="form-control" id="recipient-name" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Comentários e observações:</label>
                        <textarea class="form-control" id="message-text" placeholder="O que você quer que o contratante saiba?"></textarea>
                    </div>
                </form>
            </div>
