...
function CadastroJob() {
    ...
    async function handleCadastro(e) {
        ...
        if (compareDates(dataPagamento) === true) {
            ...
            <MainComponents>
                <div className="row d-flex ">
                    <div className="col cadastro-job">
                        <form className="container-fluid d-flex flex-column" onSubmit={handleCadastro}>
                            ...
                            <section className="row justify-content-start">
                                <div className="col-6 d-flex flex-column ">
                                    ...
                                    <select class="custom-select" id="habilidadeJob" size="3" required>
                                ...
                                <div className="col-6 justify-content-start">
                                    ...
                                    <div className="d-flex ">
                                        <input
                                            ...
                                            min="1"
                                            value={faixaPrecoMin}
                                            onChange={e => setFaixaPrecoMin(parseFloat(e.target.value))}
                                            required
                                        />
                                        <input
                                            type="number"
                                            ...
                                            placeholder="R$ max"
                                            value={faixaPrecoMax}
                                            onChange={e => setFaixaPrecoMax(parseFloat(e.target.value))}
                                            required
                                        />
                                    </div>
                                    <br />
                                    ...
                                    <div className="row">
                                        ...
                                        <section className=" col-6 ml-3" >
                                            <input
                                                ...
                                                id="prazoNegociar"
                                                onChange={e => prazoNegociar(e.target.value)}
                                            />
