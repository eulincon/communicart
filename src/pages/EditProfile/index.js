...
const EditProfile = () => {
  ...
  return (
    <div className="py-5 full-editar-perfil">
      <div className="container py-3 px-5 form-box">
        ...
        <form id="editar-perfil" className="mb-5">
          ...
          <div className="form-group form-servicos mb-4" id="checkbox-servicos">
              ...
              <div className="col-sm-6">
                ...
                <div className="custom-file" id="inserir-imagem">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label className="custom-file-label" htmlFor="imagem-perfil">
                    Anexe uma foto
                  </label>
                </div>
              </div>
        ...
        <div className="d-flex mt-5 mb-3">
          <button
            className="text-center bg-dark px-4 py-2 btn-cadastro"
